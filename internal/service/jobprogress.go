...
func watchInstallProgress(ctx context.Context, j *job.Job, sdkRoot string, packages []string, baseURL string) func() {
	watchCtx, cancel := context.WithCancel(ctx)

	go sdk.WatchInstallProgressFrom(watchCtx, sdkRoot, packages, baseURL, func(p sdk.DownloadProgress) {
